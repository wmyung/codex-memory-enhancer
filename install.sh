...
cp "$SCRIPT_DIR/skills/local-memory/l3.py" "$SKILL_DIR/"
cp "$SCRIPT_DIR/skills/local-memory/l3_graph.py" "$SKILL_DIR/"
chmod +x "$SKILL_DIR/l3.py" "$SKILL_DIR/l3_graph.py"
...
echo ""
echo "L3 knowledge graph layer:"
echo "  export L3_DB_PATH=~/.codex/skills/local-memory/memory.sqlite3"
echo "  python3 ~/.codex/skills/local-memory/l3.py stats"
echo "  python3 ~/.codex/skills/local-memory/l3_graph.py graph.html"
echo ""
echo "Docs:"
